...
export function deserializeIntoConfirmEmailCommand(
  ...
  return {
    confirmationCode: (n) => {
      confirmEmailCommand.confirmationCode = n.getStringValue();
    },
    userId: (n) => {
      confirmEmailCommand.userId = n.getStringValue();
    },
  };
}
/**
...
export function deserializeIntoCreateTaskCommand(
  ...
  return {
    attribute: (n) => {
      createTaskCommand.attribute = n.getNumberValue();
    },
    daysOfWeek: (n) => {
      createTaskCommand.daysOfWeek = n.getCollectionOfPrimitiveValues<number>();
    },
    description: (n) => {
      createTaskCommand.description = n.getStringValue();
    },
    endDate: (n) => {
      createTaskCommand.endDate = n.getDateOnlyValue();
    },
    exp: (n) => {
      createTaskCommand.exp = n.getNumberValue();
    },
    repeatInterval: (n) => {
      createTaskCommand.repeatInterval = n.getNumberValue();
    },
    repetitionType: (n) => {
      createTaskCommand.repetitionType = n.getNumberValue();
    },
    startDate: (n) => {
      createTaskCommand.startDate = n.getDateOnlyValue();
    },
    title: (n) => {
      createTaskCommand.title = n.getStringValue();
    },
  };
}
/**
...
export function deserializeIntoLoginResponse(
  ...
  return {
    accessToken: (n) => {
      loginResponse.accessToken = n.getStringValue();
    },
    expiresIn: (n) => {
      loginResponse.expiresIn = n.getNumberValue();
    },
    refreshToken: (n) => {
      loginResponse.refreshToken = n.getStringValue();
    },
    tokenType: (n) => {
      loginResponse.tokenType = n.getStringValue();
    },
  };
}
/**
...
export function deserializeIntoLoginUserCommand(
  ...
  return {
    email: (n) => {
      loginUserCommand.email = n.getStringValue();
    },
    password: (n) => {
      loginUserCommand.password = n.getStringValue();
    },
  };
}
/**
...
export function deserializeIntoRegisterUserCommand(
  ...
  return {
    email: (n) => {
      registerUserCommand.email = n.getStringValue();
    },
    password: (n) => {
      registerUserCommand.password = n.getStringValue();
    },
    username: (n) => {
      registerUserCommand.username = n.getStringValue();
    },
  };
}
/**
...
export function deserializeIntoUpdateUserDetailsCommand(
  ...
  return {
    username: (n) => {
      updateUserDetailsCommand.username = n.getStringValue();
    },
  };
}
