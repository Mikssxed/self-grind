...
public interface IHabitsRepository
{
    ...
    Task<(Habit[] Items, int TotalCount)> GetAllWithEntriesForDayAsync(string userId, DateTime day, int page, int pageSize, CancellationToken cancellationToken = default);
